        ...
        <div className="max-w-3xl text-primary-foreground">
          ...
          <div className="hero-in hero-in-2 mt-6 inline-flex items-center gap-3 rounded-full border border-white/25 bg-white/10 px-4 py-2 backdrop-blur">
            <span className="flex items-center gap-0.5">
              {[0, 1, 2, 3, 4].map((i) => (
                <Star key={i} className="h-4 w-4 fill-[oklch(0.85_0.15_85)] text-[oklch(0.85_0.15_85)]" />
              ))}
            </span>
          ...
          <div className="hero-in hero-in-5 mt-10 flex flex-wrap gap-4">
            <a href={`tel:${PHONE}`}>
              <Button size="lg" className="glass-cta h-14 rounded-full bg-transparent px-9 text-lg font-semibold text-[oklch(0.2_0.04_55)] hover:bg-transparent">
                <Phone className="mr-2 h-5 w-5" /> Call Now
              </Button>
            </a>
            <a href={waLink("Hi Vimala Flour Mill, I'd like to enquire about your grinding services.")} target="_blank" rel="noreferrer">
              <Button size="lg" variant="outline" className="glass-cta-light h-14 rounded-full border border-white/50 !bg-[oklch(0.24_0.04_55/0.45)] px-9 text-lg font-semibold text-white hover:text-white">
