...
function RefundPolicyPage() {
  return (
    <PolicyPage title="Delivery, Cancellation & Refund Policy" updated="13 September 2026">
      <PolicySection title="Delivery">
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            ...
            the mill during business hours (9:00 AM – 10:00 PM, all days).
          </li>
      ...
      <PolicySection title="Payment">
        <p>
          We currently collect payment on delivery or at pickup (cash or UPI). No online prepayment
          is taken through the website at this time.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Cancellations">
        <ul className="list-disc space-y-1.5 pl-5">
          <li>
            ...
            packing it — just message us on WhatsApp or call {PHONE}.
          </li>
          <li>
      ...
      <PolicySection title="Replacements & refunds">
        <p>
        ...
        <p>
          To report an issue, message us on WhatsApp at {PHONE} with your order details, or email{" "}
          {EMAIL}. Approved refunds for cash-on-delivery orders are settled directly with you; if
          online payment is paid in advance in future, refunds will be made to the original payment
          method within a reasonable time after approval.
        </p>
      </PolicySection>
